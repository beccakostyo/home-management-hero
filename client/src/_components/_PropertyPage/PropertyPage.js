...
import { faChevronCircleLeft, faAngleDoubleDown, faTaxi, faFireExtinguisher, faHospitalSymbol, faStethoscope, faAddressCard, faWarehouse } from '@fortawesome/free-solid-svg-icons';
...
class PropertyPage extends Component {
  ...
  renderImage() {
    if (this.state.property.image === "") {
      ...
      return <img src={this.state.property.image} alt="Property" />
    }
  }
